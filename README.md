# Korea stock market API

Real-time Korea stock market API with WebSocket, OHLCV, and snapshot endpoints for KRX.

## Build With Korea Market Data

Kun Data provides a token-authenticated API stack for developers who need Korea market data in products that must load fast, stream live prices, and support charting or screening workflows.

This repository is focused on Korea coverage with support for KRX and is designed for teams building broker dashboards, watchlists, quant tools, stock screeners, mobile apps, and market overview pages.

## Why Developers Search For This

Developers usually need one or more of these:

- Real-time Korea stock market API
...
`Korea stock market API | KRX API | Korean stock data API | Korea OHLCV API`
...
### Does this support real-time Korea market data?
...
If you need Korea market data coverage for KRX, start with the product page and documentation:
