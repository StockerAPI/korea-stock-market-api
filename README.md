...
Kun Data provides real-time market data for Korea through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Korea market coverage with support for KRX.

## API Capabilities

- Real-time WebSocket market data for Korea
...
This repository is designed to make Korea market API coverage easier to discover and evaluate.
